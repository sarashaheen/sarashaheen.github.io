...
Network = () ->
  ...
  setupData = (data) ->
    ...
    countExtent = d3.extent(data.nodes, (d) -> d.strength)
    ...
    data.nodes.forEach (n) ->
      ...
      n.radius = circleRadius(n.strength)
  ...
  filterNodes = (allNodes) ->
    ...
    if filter == "popular" or filter == "obscure"
      playcounts = allNodes.map((d) -> d.strength).sort(d3.ascending)
...
$ ->
  ...
  d3.json "data/all_turns.json", (json) ->
    myNetwork("#vis", json)
